...
from mock_data import MAP_SIZE, OBSTACLES, START, GOAL, GOAL_BIAS, CLEARANCE
...
def steer(from_pos, to_pos, step_size):
    ...
    # This gives step exactly step_size meters long
...
def is_collision_free_path(pos_a, pos_b, obstacles, num_checks=10):
    """
...
if __name__ == "__main__":
    from mock_data import STEP_SIZE
